...
final class CreateSessionMutationResolver implements MutationResolverInterface
{
    ...
    public function __invoke($item, array $context)
    {
        ...
        try {
            $sessionTypeRepository = $this->em->getRepository("App\Entity\SessionType");
            /**
             * @var SessionType $sessionType
             */
            $sessionType = $sessionTypeRepository->findOneBy(["name" => "SITE_SESSION"]);

            /**
             * @var Session[] $sessions
             */
            $sessions = $this->em->getRepository(Session::class)->findBy(['user' => $item->getUser(), 'end_time' => null]);
            ...
            $item->setSessionState("ACTIVE");
            $item->setIpAddress($detectedIp);
